...
{
    public partial class SecureItemsPage : ContentPage
    {
        private CancellationTokenSource? _longPressCts;
        private const int LongPressThresholdMs = 500;

        public SecureItemsPage()
        {
            InitializeComponent();
        }
        ...
        private async void OnItemButtonPressed(object? sender, EventArgs e)
        {
            ...
            var item = (sender as Button)?.CommandParameter as SecureItemViewModel;
            ...
            try
            {
                ...
                if (BindingContext is SecureItemsPageViewModel vm)
        ...
        private void OnItemButtonReleased(object? sender, EventArgs e)
        {
            ...
            if (sender is Button btn && btn.Command is null && BindingContext is SecureItemsPageViewModel)
            {
